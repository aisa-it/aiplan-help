...
При необходимости панель скрывается/раскрывается нажатием ОКМ на значок меню ![icon_menu](/imgs/icon_menu.jpg) слева вверху.

![menu_1](/imgs/menu_1.jpg)

**Высота и ширина** подразделов меню **является регулируемой**. Для изменения необходимо кликнуть на границу подраздела и потянуть мышью в нужную сторону. Также при необходимости можно **изменить порядок разделов меню**. Для этого нужно кликнуть на выбранный раздел мышью и потянуть вверх или вниз.  
...
- увидеть главную страницу выбранного пространства;
...
- [создать спринт](../7_sprints/7_sprints.md).

В нижней части панели меню находятся кнопки: 

- ![спринты](/imgs/sprints_button.jpg), по нажатию которой открывается выпадающий список созданных в пространстве спринтов;

- ![формы](/imgs/forms_button.jpg), по нажатию которой открывается выпадающий список созданных в пространстве форм;

- ![АИДок](/imgs/aidoc_button.jpg), по нажатию которой открывается раздел "АИДок", содержащий документы пространства;
...
![versions_change](/imgs/versions_change.jpg)
