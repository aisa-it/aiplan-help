...
Для перехода в раздел "АИДок" необходимо нажать на кнопку ![кнопка_АИДок](/imgs/aidoc_button.jpg) в панели меню слева. При переходе в раздел документов пространства панель меню меняется на дерево страниц "АИДок". 
...
Чтобы **выйти из раздела "АИДок"** достаточно нажать на название пространства в адресной строке.
