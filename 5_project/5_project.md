...
Перейти к задачам проекта сотруднику разрешено только в те проекты, где он - в списке пользователей.  
...
Нажатием на значок ![button_3points](/imgs/button_3points.jpg) рядом с названием проекта осуществляются:  
...
Для удаления проекта из категории "Избранное" необходимо повторно нажать на закрашенный значок. 
