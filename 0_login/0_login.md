...
После заполнения формы обязательно нажать кнопку "**Войти**" внизу окна.  
    ...
    В случае 5-кратного введения неправильного логина или пароля, произойдет блокировка учетной записи.

**Если авторизация прошла успешно**, то:
- *зарегистрированный пользователь* АИПлан сразу будет направлен на [Главную страницу](../1_home_page/1_home_page.md);
